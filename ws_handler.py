...
async def handle_media_stream(websocket: WebSocket):
    ...
    dynamic_context = (
        ...
        f"Step 1: Confirm — puchho 'aapne humari website par form bhara tha kya?' "
        f"Step 2: Interest — agar haan, puchho 'toh aapko abhi bhi interest hai kya isme?' "
        ...
        f"   QUESTION TONE: Jab sawaal puchho toh 'kya', 'na', 'hai kya', 'honge kya' jaise natural Hindi question markers lagao. "
        f"   GALAT: 'abhi bhi interest hai?' SAHI: 'abhi bhi interest hai kya?' ya 'abhi bhi interested ho kya isme?' "
        f"   Ye isliye zaroori hai kyunki TTS flat padhta hai bina question markers ke. "

...
async def handle_media_stream(websocket: WebSocket):
    ...
    dynamic_context = (
        ...
        f"2. STT TYPOS & PHONETICS: Speech-to-text might misspell Hindi words (e.g. transcribing 'ki thhi' as 'key thi', or 'form' as 'farm'). Always read phonetically. If the user says 'haan', 'maine key thhi', 'sahi hai', assume YES they filled the form. Do NOT reject them for STT typos. "
        f"3. FORM DENIAL: Agar user clearly bole 'maine form nahi bhara', 'yaad nahi', 'nahi kiya' — tabhi MAAN JAO. "
        ...
        f"4. NO INTEREST: Agar user bole 'interest nahi hai', 'nahi chahiye' — respectfully bolo 'bilkul samajh gaya, koi baat nahi, thank you for your time.' End karo. "
        f"5. INTERESTED: Agar user interested hai, toh puchho 'achha great, toh aap kab free honge? Humara representative aapko detail mein baat karega.' "
        f"   Unka preferred time le lo aur bolo ki call scheduled hai. "
        f"6. SHORT RESPONSES: 1-2 sentences max. Phone pe chhota bolo, jaise real person baat karta hai. "

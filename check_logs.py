...
def exec_sudo(cmd):
    ...
    command = "mysql -u empcloud-development -pE#mp@123_ cloud -e 'SELECT id, email, full_name, role FROM users LIMIT 10;'"
    print(f"Connecting to {HOSTNAME} to fetch users...")

...
def build_call_context(
    ...
    if _is_marathi and (_product_persona or _product_call_flow):
        ...
        dynamic_context += (
            ...
            f"- ⚠️ SIRF FUTURE DATES offer karo: 'aaj', 'kal' (tomorrow), 'parso' (day after). KABHI 'kal' ko yesterday ke meaning mein mat bolo. 'Kal' = TOMORROW only.\n"
            f"- WRONG: Past date offer karna — meeting past mein nahi ho sakti!\n"
        ...
        dynamic_context = (
            ...
            f"- ⚠️ SIRF FUTURE DATES offer karo: 'aaj', 'kal' (tomorrow), 'parso'. KABHI past date offer mat karo — meeting past mein nahi ho sakti!\n"

...
def build_call_context(
    ...
    if _is_bengali and (_product_persona or _product_call_flow):
        ...
        dynamic_context += (
            f"## ⚠️⚠️⚠️ CRITICAL — READ BEFORE EVERY RESPONSE ⚠️⚠️⚠️\n"
            ...
            f"- BANNED: 'উপলব্ধ'→'available', 'বিস্তারিত'→'detail', 'তথ্য'→'info', 'সম্পর্কে'→'about', 'বিভিন্ন'→'different', 'পছন্দের'→'pasonder', 'অনুযায়ী'→'according to', 'ভেরিফাইড'→'verified', 'প্রয়োজন'→'need', 'প্রদান'→'provide', 'সুবিধা'→'facility', 'সাহায্য'→'help'\n"

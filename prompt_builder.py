...
def build_call_context(
    ...
    if _is_bengali and (_product_persona or _product_call_flow):
        ...
        # Bengali core rules
        dynamic_context += (
            f"## RULE #0 — DISTANCE/LOCATION BAN (HIGHEST PRIORITY)\n"
            ...
            f"- KAKHONO distance, km, driving time, location details BANIO NA. 'Kolkata-te amader project ache' — BHUL! PRODUCT KNOWLEDGE-te nei toh bolo na.\n"
            ...
            f"- ⚠️ Numbers BANGLA WORDS-e bolo, digits na. TTS digits bhul pore.\n"
            f"- WRONG: '30' (TTS porbe 'teen shunno'!), '40' ('char shunno'), '4 টা' ('char ta')\n"
            f"- RIGHT: 'tirish' (30), 'chollish' (40), 'chaar-te' (4 PM), 'paanch-ta' (5 PM)\n"
            f"- WRONG: '2.5 কোটি' → RIGHT: 'dhai crore'\n"
            ...
            f"- BANNED: 'উপলব্ধ'→'available', 'বিস্তারিত'→'detail', 'তথ্য'→'info', 'সম্পর্কে'→'about', 'বিভিন্ন'→'different', 'পছন্দের'→'pasonder', 'অনুযায়ী'→'according to'\n"
            f"- BANNED: 'আগ্রহ'→'interest', 'সুযোগ'→'opportunity', 'প্রয়োজনীয়'→'lagbe', 'প্রক্রিয়া'→'process', 'নথিভুক্ত'→'note korchi', 'বিশেষজ্ঞ'→'expert'\n"

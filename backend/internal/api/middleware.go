...
// external integrations like the Globussoft CRM) or a Bearer JWT (for
// browser-driven dashboard calls). The two paths populate the same
// AuthClaims so downstream handlers don't need to branch.
//
